...
namespace deniszykov.BaseN
{
	...
	{
		/// <summary>
		/// Encoder/decoder class for Base64 (URL safe) alphabet. Used for streaming.
		/// </summary>
		public static readonly BaseNEncoding Encoding = BaseNEncoding.Base64Url; 
		...
		public static byte[] ToBytes(char[] base64Chars, int offset, int count)
		{
			...
			return Encoding.GetBytes(base64Chars, offset, count);
		}
		/// <summary>
		...
		public static byte[] ToBytes(string base64String, int offset, int count)
		{
			...
			return Encoding.GetBytes(base64String, offset, count);
		}
		/// <summary>
